...
CriaRedes <- function (areaphase, areatype){
  treino <- areaphase[1:floor(0.8*(dim(areaphase)[1])),]
  teste <- areaphase[1:floor(0.2*(dim(areaphase)[1])),]
...
```{r TESTE} 
areas <- iniciaTeste()
summary(areas_treino[[1]][[1]])
CriaRedes(areas[[1]][[1]], 1)
CriaRedes(areas[[2]][[1]], 2)
CriaRedes(areas[[3]][[1]], 3)
CriaRedes(areas[[4]][[1]], 4)
CriaRedes(areas[[5]][[1]], 5)
CriaRedes(areas[[6]][[1]], 6)
```
